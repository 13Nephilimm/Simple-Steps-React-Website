...
const resources = {
  en: {
    translation: {
      ...
      months: "months",
      lecture: "lectures",
      nikaSandroTime1: "monday, wednesday, friday",
      nikaSandroTime2: "tuesday, thursday, saturday",
      nikaSandroPrice: "The cost of the course is 950₾",
      nikaSandroPlace: "the amount of places per group 8 students only",
      nikaSandroName: "Digital marketing course",
      lecturers: "Lecturers",
      duration: "Duration",
      period: "Period",
      soon: "Soon...",
      googleAds: "Google ads & Search engine optimization",
      schedule: "Schedule",
      courseSyllabus: "Course Syllabus",
      tiko: "Tinatin Gogberashvili",
      tikoPrice: "The cost of the course is 650₾",
      noOffline: "Lectures are held online only",
      tikoTime: "monday, wednesday, thursday",
      tikoPlace: "the amount of places per group 8 students only",
      weeks: "weeks",
      nikaSandroDesc:
  ...
  ge: {
    translation: {
      ...
      googleAds: "Google ads & საძიებო სისტემის ოპტიმიზაცია",
      metaExamText:
      ...
      months: "თვე",
      lecture: "ლექცია",
      nikaSandroTime1: "ორშაბათი, ოთხშაბათი, პარასკევი",
      nikaSandroTime2: "სამშაბათი, ხუთშაბათი, შაბათი",
      nikaSandroPrice: "კურსის ღირებულება 950₾",
      nikaSandroPlace: "ჯგუფი შედგება 8 სტუდენტისგან",
      nikaSandroName: "ციფრული მარკეტინგის კურსი",
      lecturers: "ლექტორები",
      duration: "ხანგრძლივობა",
      period: "პერიოდი",
      soon: "მალე...",
      schedule: "განრიგი",
      courseSyllabus: "კურსის სილაბუსი",
      tiko: "თინათინ გოგბერაშვილი",
      tikoPrice: "კურსის ღირებულება 650₾",
      noOffline: "ლექციები მიმდინარეობს მხოლოდ ონლაინ",
      tikoTime: "ორშაბათი, ოთხშაბათი, ხუთშაბათი",
      tikoPlace: "ჯგუფი შედგება 8 სტუდენტისგან",
      weeks: "კვირა",
      nikaSandroDesc:
